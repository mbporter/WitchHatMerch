...
- `data/products.json` — sample product data used by `database.html`
...
- Add or edit entries in `data/products.json` to update the database. Each product should include: id, name, type, price, image, description, note, buy_link.
